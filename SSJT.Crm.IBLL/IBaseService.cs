...
namespace SSJT.Crm.IBLL
{
    public interface IBaseService<T> where T:class,new()
    {
        ...
        /// <returns></returns>
        IEnumerable<T> LoadPageEntities<S>(int pageIndex, int pageSize, out int totalCount, bool isAsc, Expression<Func<T, S>> orederLambdaWhere, Expression<Func<T, bool>> lambdaWhere);
        /// <summary>
        /// 得到最大的ID
        /// </summary>
        /// <returns></returns>
