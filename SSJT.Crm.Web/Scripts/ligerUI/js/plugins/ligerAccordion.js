    ...
    { 
        return this.each(function()
        {
            ...
            }).click(function()
            {
                if ($(this).hasClass("l-accordion-toggle-close"))
                {
                    $(this).removeClass("l-accordion-toggle-close")
                    .removeClass("l-accordion-toggle-close-over l-accordion-toggle-open-over") 
                    $(this).addClass("l-accordion-toggle-open");
                    $(this).parent().next(".l-accordion-content")
                    .show(p.speed)
                    .siblings(".l-accordion-content:visible").hide(p.speed);
                    $(this).parent().siblings(".l-accordion-header").find(".l-accordion-toggle").removeClass("l-accordion-toggle-open").addClass("l-accordion-toggle-close");
                }
                else
                {
                    ...
                    $(this).parent().next(".l-accordion-content").hide(p.speed);
                }
            });
            //init
